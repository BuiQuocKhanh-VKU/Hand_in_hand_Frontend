						...
						<ModalBody>
							<div className="modal-email-body">
								<div className="input-container">
									<label>
										Trước khi thay đổi tài khoản, bạn cần nhập mã mà chúng tôi đã gửi đến
									</label>
									<label
										style={{
											marginTop: "10px",
						...
						<div className="right_content">
							<div className="right_content_inner">
								...
								<div className="right_email">
									<div className="right_email_text"><p>Địa chỉ này sẽ được sử dụng để gửi thông tin cập nhật trạng thái đơn hàng cho bạn.</p> </div>
