...
const OrangePlan = (props) => {
   const orangePlanRef = useRef(null); // Ref đến section cần thiết
   ...
   // 	let response = await getAllProducts("2");
   // 	if (response && response.errCode === 0) { // errCode là khóa để kiểm tra trạng thái của phản hồi, === 0 có nghĩa là thành công
   // 		setArrCheckout(response.products);
   // 	}
   // }
      ...
      <div className="OrangePlan-container" ref={orangePlanRef}>
         <div className="OrangePlan-content">
            <div className="OrangePlan-content-left">
               <div className="OrangePlan-image"></div>
            </div>
               ...
               <div className="buy-product-OrangePlan">
                  <div className="bg">
                     ...
                     <p>
                        ...
                        360.000 VND cho mỗi đơn hàng. Bạn có thể dễ dàng quản lý đăng ký của mình hoặc hủy bỏ bất kỳ lúc
                  ...
                  <div className="description">
                     ...
                     <p>
                        <strong>Trồng 7 cây mỗi tháng</strong>
                     </p>
                     <p>
                        <strong>Cân bằng 140kgs CO2 mỗi tháng</strong>
                     </p>
                  </div>
