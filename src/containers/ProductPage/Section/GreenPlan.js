...
const GreenPlan = (props) => {
   const greenPlanRef = useRef(null); // Ref đến section cần thiết
      ...
      <div className="GreenPlan-container" ref={greenPlanRef}>
         <div className="GreenPlan-content">
            <div className="GreenPlan-content-left">
               <div className="GreenPlan-image"></div>
            </div>
               ...
               <div className="buy-product-GreenPlan">
                  <div className="bg">
                     ...
                     <p>
                        ...
                        5.000 VND cho mỗi đơn hàng. Bạn có thể dễ dàng quản lý đăng ký của mình hoặc hủy bỏ bất kỳ lúc
                  ...
                  <div className="description">
                     ...
                     <p>
                        <strong>Cân bằng 7kg CO2 mỗi tháng</strong>
                     </p>
                  </div>
